	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav menus">
				...
				<li class="nav-item"><a class="nav-link" href="supplier.php" id="supplier_menu">Personal</a></li>
				<li class="nav-item"><a class="nav-link" href="product.php" id="product_menu">Material</a></li>
				
				<li class="nav-item"><a class="nav-link" href="qrscanner.php" id="purchase_menu">QR scanner</a></li>
			</ul>
		</div>
